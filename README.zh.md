...
你的志愿表 (PDF)                投档线数据 (XLS)
┌──────────────────────┐       ┌──────────────────────┐
│ 志愿1: [A246] 复旦大学  │       │ A246+33 → 最低位次 583 │
│   专业33: 计算机科学   │       │ A246+34 → 最低位次 612 │
│ 志愿2: [A246] 复旦大学  │  VS   │ A269+01 → 最低位次 248 │
│   专业34: 数学         │       │ ...                  │
│ 志愿3: [A269] 上海交大  │       │                      │
│   专业01: 电子信息     │       │                      │
│ ...                   │       │                      │
...
**判断规则：** 对于每个志愿，在投档线中查找 (院校代码, 专业代码) 组合。如果你的位次 ≤ 该专业去年最低位次，则预测会被录取。位次越小排名越靠前。
